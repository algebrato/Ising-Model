...
Un ulteriore passo da fare nella ricerca della performance migliore, \`e quello di cercare il miglior numero di \emph{threads} da assegnare ad ogni singolo \emph{blocco} in modo da saturarne l'utilizzo.
\begin{figure}
	\centering
		\includegraphics[width=120mm,angle=0,clip=]{../CUDA/Result/Res3/Time_BLOCK.pdf}
		\caption{Ottimizzazione della dimensione del blocco}
